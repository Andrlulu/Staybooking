...
public class DevRunner implements ApplicationRunner {
    ...
    // below are sample data to be used for testing
    private void generateSampleData() {
        ...
        // below are sample listing data to be used for testing
        // including geometry data using org.locationtech.jts.geom.GeometryFactory api
        ...
        // below are sample booking data to be used for testing
