...
public class GlobalControllerExceptionHandler {
    // handling error based on the input type

    // EntityNotFound is not written by me. help check if there is a resource.
    @ExceptionHandler(EntityNotFoundException.class) // excpetion anaotation helps find the exception in each function
