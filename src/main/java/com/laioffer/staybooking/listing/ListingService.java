...
public class ListingService {
    ...
    public void createListing(
        ...
        List<String> uploadedUrls = images.parallelStream() // parallelSteam can handle images in parallel, in different thread
                .filter(image -> !image.isEmpty())
                .map(imageStorageService::upload)
                .toList();


        GeoPoint geoPoint = geocodingService.getGeoPoint(address); // get geo location with address
    ...
    public void deleteListing(long hostId, long listingId) {
        ...
        // making sure who is deleting it
        ...
        // making sure if the booking existed for this listing
