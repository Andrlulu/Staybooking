...
public class BookingEntity {
    ...
    private ListingEntity listing; // many to one relationship to listing entity, fk


    @ManyToOne
    @OnDelete(action=OnDeleteAction.CASCADE)
    @JoinColumn(name = "guest_id", foreignKey = @ForeignKey(name = "fk_booking_guest"), insertable = false, updatable = false) // insertable = false, prevents extra unwanted operation
    private UserEntity guest; // many to one relationship to guest entity, fk
