...
public class ListingEntity {
    ...
    private Long id;
    @Column(name = "host_id") // for redundancy
    private Long hostId;
    private String name;
    ...
    @ManyToOne // many to one relationship to user entity
    @OnDelete(action = OnDeleteAction.CASCADE) //
    @JoinColumn(name = "host_id", foreignKey = @ForeignKey(name = "fk_listing_host"), insertable = false, updatable = false) // adding constraint to host_id column to prevent
