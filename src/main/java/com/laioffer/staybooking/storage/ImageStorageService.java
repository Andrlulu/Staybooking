...
public class ImageStorageService {
    ...
    // bucket config in application yaml is injected into this constructor
    ...
    public String upload(MultipartFile file) {
        String filename = UUID.randomUUID().toString(); // universal unique identifier, randomly generated an id.
        BlobInfo blobInfo;
        try {
